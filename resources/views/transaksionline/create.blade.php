...
<div class="container">
    ...
    <p class="text-center">Silahkan Melakukan Transaksi pada No.Rekening : 5410425787 a.n. SIERURENTARU</p>
    @if ($errors->any())
        ...
        <div class="col-md-12 mb-3">
            <form method="POST" action="/transaksionline/store" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <label for="barangs_id">Barang yang di belanjakan</label>
